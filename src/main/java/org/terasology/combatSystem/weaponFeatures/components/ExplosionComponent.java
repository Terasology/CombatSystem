...
public class ExplosionComponent implements Component {
    @Replicate
    public List<CollisionGroup> collidesWith = Lists.newArrayList(StandardCollisionGroup.DEFAULT,
            StandardCollisionGroup.WORLD, StandardCollisionGroup.CHARACTER);
